...
int main(int argc, char *argv[])
{
    ...
    while (command != EXIT) {
        ...
        case EFFICIENCY:
            ...
            print_t_efficiency(avg_keys_buble, avg_keys_insertion, avg_flats_buble, avg_flats_insertion);
            print_m_efficiency(sizeof(fkey_t) * n_flats, sizeof(fkey_t) * n_flats, sizeof(flat_t) * n_flats,
                               sizeof(flat_t) * n_flats);
