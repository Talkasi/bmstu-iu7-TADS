...
#define CREATE_DEFAULT_SETTINGS(s)                                                                                     \
    settings_t s = {DEFAULT_QUEUE_1_MIN_TIME, DEFAULT_QUEUE_1_MAX_TIME, DEFAULT_QUEUE_2_MIN_TIME,                      \
                    DEFAULT_QUEUE_2_MAX_TIME, DEFAULT_POSSIBILITY}

void pre_init_all(array_queue_t *array_q1, array_queue_t *array_q2, list_queue_t *list_q1, list_queue_t *list_q2,
...
int main(void)
{
    ...
    while (command != EXIT) {
        ...
        case CHANGE_POSSIBILITY:
            ...
            while (read_double(&settings.possibility) || settings.possibility < 0 || settings.possibility > 1)
